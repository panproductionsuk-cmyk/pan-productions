...
export interface ProductionCategories {
  theatre: Production[];
  music: Production[];
  art: Production[];
  film: Production[];
...
export const categories: ProductionCategories = {
  theatre: [
    {
      id: 'love-of-rumi',
...
export const allProductions: Production[] = [
  ...categories.theatre,
  ...categories.music,
  ...categories.art,
  ...categories.film,
...
export const marketingProductions: Production[] = allProductions.filter(
  (p) => p.showInMarketing === true
);
